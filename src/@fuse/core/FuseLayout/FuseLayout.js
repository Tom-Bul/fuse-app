...
import FuseLayouts from 'app/fuse-layouts/layout1/Layout1';
...
function FuseLayout(props) {
	...
	return _.isEqual(newSettings.current, settings) ? <FuseLayouts classes={{ root: classes.root }} {...props} /> : null;
}
